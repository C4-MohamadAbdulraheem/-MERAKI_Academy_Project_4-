  ...
  return (
    <div className="main-visa">
      <div className="visa-card">
        ...
        />
        <br />
        <input type="text" placeholder="Name on the card" className="card" />
        <br />
        ...
        <div className="card-details">
          ...
          <input type="text" placeholder="CVV" className="card-2" />
          <br />
        </div>
            ...
            onClick={() => {
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  Swal.fire("Paid", "Your Payment is Done.", "success");
                  navigation("/products");
                }
              });
            }}
